            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                  ...
                  <ul className="list-disc list-inside space-y-2 text-darkText">
                    <li><span className="font-bold">The Leaning Pear</span> - Sophisticated Hill Country cuisine with riverside dining</li>
                    <li><span className="font-bold">Jobell Cafe & Bistro</span> - French-inspired dishes with Texas influences</li>
                    <li><span className="font-bold">Community Pizza</span> - Wood-fired pizzas with creative toppings and craft beer</li>
                    <li><span className="font-bold">Ino'z Brew and Chew</span> - Casual dining with a deck overlooking Cypress Creek</li>
                    <li><span className="font-bold">Wimberley Cafe</span> - Classic Texas breakfast and comfort food</li>
                    <li><span className="font-bold">Hays City Store</span> - Barbecue and Tex-Mex in a historic building</li>
                    <li><span className="font-bold">Creekside Cookers</span> - Authentic Texas barbecue served Thursday-Sunday</li>
                  </ul>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <h4 className="text-xl font-bold text-primary mb-3 font-heading">Wineries and Breweries</h4>
                  <ul className="list-disc list-inside space-y-2 text-darkText">
                    <li><span className="font-bold">Wimberley Valley Winery</span> - Local wines with a tasting room and vineyard tours</li>
                    <li><span className="font-bold">Cypress Creek Reserve Rum Distillery</span> - Handcrafted rum with tours and tastings</li>
                    <li><span className="font-bold">Middleton Brewing</span> - Craft brewery with a scenic Hill Country view</li>
                    <li><span className="font-bold">Roughhouse Brewing</span> - Farm brewery specializing in naturally fermented beers</li>
                  </ul>
                </div>
              </div>
            </div>
