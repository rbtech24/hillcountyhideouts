          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-darkText mb-4">
                  <li><span className="font-bold">Treaty Oak Distilling</span> - Expansive ranch featuring whiskey and gin production, restaurant, and events</li>
                  <li><span className="font-bold">Deep Eddy Vodka</span> - Known for natural fruit-infused vodkas with a tasting room and tour facility</li>
                  <li><span className="font-bold">Dripping Springs Distilling</span> - Family-owned distillery producing artisanal vodka and gin</li>
                  <li><span className="font-bold">Desert Door Distillery</span> - Texas' first sotol distillery, featuring a stylish tasting room</li>
                  <li><span className="font-bold">Frog Pond Distillery</span> - Small-batch operation with innovative spirits</li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-darkText mb-4">
                  <li><span className="font-bold">Jester King Brewery</span> - Farmhouse brewery specializing in wild ales on a 165-acre ranch</li>
                  <li><span className="font-bold">Vista Brewing</span> - Farm-brewery with beautiful grounds, restaurant, and live music</li>
                  <li><span className="font-bold">Ghost Note Brewing</span> - Small craft brewery with rotating taps and food trucks</li>
                  <li><span className="font-bold">Family Business Beer Co.</span> - Family-friendly brewery with spacious grounds and playground</li>
                  <li><span className="font-bold">12 Fox Beer Co.</span> - Veteran-owned brewery with an emphasis on German styles</li>
                </ul>
              </div>
            </div>
