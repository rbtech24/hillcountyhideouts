          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-darkText mb-4">
                  <li><span className="font-bold">Becker Vineyards</span> - One of the pioneers of Texas wine</li>
                  <li><span className="font-bold">Grape Creek Vineyards</span> - "Tuscany in Texas" atmosphere</li>
                  <li><span className="font-bold">Pedernales Cellars</span> - Award-winning Tempranillo and Viognier</li>
                  <li><span className="font-bold">William Chris Vineyards</span> - 100% Texas-grown philosophy</li>
                  <li><span className="font-bold">Signor Vineyards</span> - Beautiful grounds and architecture</li>
                </ul>
              </div>
            </div>
